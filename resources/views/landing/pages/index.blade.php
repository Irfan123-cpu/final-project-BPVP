        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1 text-center">
                    <div class="hero-text">
                        <h2>WEBSITE WISATA BY APRIFAN</h2>
                        <p>Kami hadir untuk membantu Anda menemukan destinasi wisata terbaik dengan pengalaman yang mudah,
                            cepat, dan menyenangkan.</p>
                        <div class="home_btn">
                            <a href="#" class="app-btn home_btn_color_one">Info Lebih Lanjut</a>
                            <a href="#" class="app-btn home_btn_color_two">Wisata Kami</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-sm-12 col-xs-12">
                        <div class="single_property">
                            ...
                            <div class="single_property_price">
                                Per TIKET BOS <span>Rp. {{ $zone->price_range }}</span>
        ...
        <div class="container">
            ...
            <div class="row portfolio-items-list">
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom kitchen garage">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/1.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/1.jpg') }}"></a>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom garage">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/2.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/2.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/3.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/3.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix garage kitchen">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/4.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/4.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/5.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/5.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom kitchen">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/6.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/6.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix basement garage">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/7.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/7.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom basement">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/8.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/8.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom basement">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/assets/img/portfolio/9.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/assets/img/portfolio/9.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
    ...
    <section id="team" class="our_team section-padding">
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-12">
                    <div class="single_team">
                        <img src="{{ asset('/storage/landing/assets/img/team/team-3.jpg') }}" class="img-fluid"
                            alt="" />
                        <h3>Syed Ekram</h3>
                        <p>Co Founder</p>
                        <ul class="list-inline">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-12">
                    <div class="single_team">
                        <img src="{{ asset('/storage/landing/assets/img/team/team-4.jpg') }}" class="img-fluid"
                            alt="" />
                        <h3>Hanjala Haque</h3>
                        <p>Co Founder</p>
                        <ul class="list-inline">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="partner  wow fadeInRight">
                        <a href="#"><img src="{{ asset('/storage/landing/assets/img/partner/1.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/assets/img/partner/2.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/assets/img/partner/3.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/assets/img/partner/4.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/assets/img/partner/5.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/assets/img/partner/1.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/assets/img/partner/2.png') }}"
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-4 col-xs-12">
                    <div class="single_blog">
                        <div class="blog_img">
                            <a href="blog.html"><img src="{{ asset('/storage/landing/assets/img/blog/blog-1.jpg') }}"
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12">
                    <div class="single_blog">
                        <div class="blog_img">
                            <a href="blog.html"><img src="{{ asset('/storage/landing/assets/img/blog/blog-2.jpg') }}"
                                    class="img-fluid" alt="image" /></a>
                            <div class="post-date">
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12">
                    <div class="single_blog">
                        <div class="blog_img">
                            <a href="blog.html"><img src="{{ asset('/storage/landing/assets/img/blog/blog-3.jpg') }}"
                                    class="img-fluid" alt="image" /></a>
                            <div class="post-date">
